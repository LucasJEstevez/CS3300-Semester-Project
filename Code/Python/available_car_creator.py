# ChatGPT was used solely to understand and implement pandas for excel file creation
...
df = pd.DataFrame(data, columns=['Vehicle_ID', 'Year', 'Make', 'Model', 'Trim', 'Miles', 'Sale Price', 'Status', 'Mode of Purchase', 'Zip Code'])

# Save the DataFrame to a CSV file
file_path = "C://Users//jecam//PycharmProjects//Personal Use//site_available_cars.csv"
